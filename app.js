...
//     res.send("successful testiing");
// })


// Delete any listing where the price is null or doesn't exist------------------//
// app.get("/cleanup", async (req, res) => {
//     await Listing.deleteMany({ price: null });
//     await Listing.deleteMany({ price: { $exists: false } });
//     res.send("Bad data deleted! Go back to /listings");
// });
